      ...
      <header className="fixed left-0 right-0 top-0 z-[1000] h-[var(--aftercare-nav-h)] border-b border-[var(--aftercare-border)] bg-white/90 backdrop-blur-[20px]">
        <div className="mx-auto flex h-full max-w-[1080px] items-center gap-6 px-7">
          ...
          <nav className="flex flex-1 items-center gap-0">
            ...
            <a className="rounded-lg px-3.5 py-2 text-sm font-medium text-[var(--aftercare-text-muted)] hover:bg-black/5 hover:text-[var(--aftercare-text)]" href="#results">
              Care Plans
            </a>
          ...
          <div className="ml-auto flex items-center gap-3">
            <button className="rounded-lg px-3.5 py-2 text-sm font-medium text-[var(--aftercare-text-muted)] hover:bg-black/5 hover:text-[var(--aftercare-text)]" type="button">
              Explore
            </button>
            <button className="rounded-lg px-3.5 py-2 text-sm font-medium text-[var(--aftercare-text-muted)] hover:bg-black/5 hover:text-[var(--aftercare-text)]" type="button">
              Support
            </button>
            <button className="flex h-9 w-9 items-center justify-center rounded-full bg-black/5 text-[var(--aftercare-text)] hover:bg-black/10" type="button" aria-label="Profile">
