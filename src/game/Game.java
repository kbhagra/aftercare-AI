...
public class Game {
    ...
    public void startGame() { // start the game
        ...
        displayScore(); // call displayScore method to show the final score after all rounds are
                        // completed
    }
    ...
    private void playRound() { // play a single round of the game
        ...
        Player winner = rules.determineWinner(human, humanMove, computer, computerMove); // determine the winner of the
                                                                                         // round using the game rules
